...
const APP_BUILD_VERSION = 'kw70-split-checkout-scan-merge';
const PRODUCTION_BUILD_SYNCED_VERSION = 'kw70-split-checkout-scan-merge';
let D = {
...
// features-fi-checkoutscan-importexport-payroll.js — FI (kebebasan finansial) wrapper, list transaksi & cashflow forecast, Budget wrapper, export/import/backup data, Payroll (Absensi & Gaji Mingguan)
// (v89): blok "deteksi item checkout dari screenshot belanja" sudah dipindah ke scan-ocr.js — domainnya OCR, cuma
// dulu kepisah gara-gara ikut nomor batch lama. Lihat PEMISAHAN-FILE-ROADMAP.md.
// PENTING: file ini HARUS dimuat sesuai urutan build.js (GROUP_A/GROUP_B) karena beberapa modul saling referensi. Urutan grup ini: data-default.js, features-helpers-global-security.js, diagnostik-versi.js, format-tema.js, error-handler.js, helper-teks.js, keamanan-pin.js, modal-navigasi.js, reset-gaji-mingguan.js, debug-console.js, pengaturan-search.js, onboarding.js, kalkulator-input.js, scan-ocr.js, filter-laporan.js, akun.js, gaji-calc.js, transaksi.js, profil-pengaturan.js, kategori.js, tagihan-kalender.js, features-fi-checkoutscan-importexport-payroll.js, features-tukang-kendaraan-storage.js, features-aiwidget-reminder-gdrive-search.js, features-sheets-pwa-selftest.js
