// app-bundle-b.min.js — DIBUAT OTOMATIS oleh build.js dari: data-default.js, features-helpers-global-security.js, diagnostik-versi.js, format-tema.js, error-handler.js, helper-teks.js, keamanan-pin.js, modal-navigasi.js, reset-gaji-mingguan.js, debug-console.js, pengaturan-search.js, onboarding.js, kalkulator-input.js, scan-ocr.js, filter-laporan.js, akun.js, gaji-calc.js, transaksi.js, profil-pengaturan.js, kategori.js, tagihan-kalender.js, features-fi-checkoutscan-importexport-payroll.js, payroll-absensi.js, features-tukang-kendaraan-storage.js, features-aiwidget-reminder-gdrive-search.js, features-sheets-pwa-selftest.js
...
// PENTING: file ini HARUS dimuat sesuai urutan build.js (GROUP_A/GROUP_B) karena beberapa modul saling referensi. Urutan grup ini: data-default.js, features-helpers-global-security.js, diagnostik-versi.js, format-tema.js, error-handler.js, helper-teks.js, keamanan-pin.js, modal-navigasi.js, reset-gaji-mingguan.js, debug-console.js, pengaturan-search.js, onboarding.js, kalkulator-input.js, scan-ocr.js, akun.js, gaji-calc.js, transaksi.js, profil-pengaturan.js, kategori.js, tagihan-kalender.js, features-fi-checkoutscan-importexport-payroll.js, payroll-absensi.js, features-tukang-kendaraan-storage.js, features-aiwidget-reminder-gdrive-search.js, features-sheets-pwa-selftest.js
...
const APP_BUILD_VERSION = 'kw70-split-payroll-absensi';
const PRODUCTION_BUILD_SYNCED_VERSION = 'kw70-split-payroll-absensi';
let D = {
...
function openModal(id){document.getElementById(id).classList.add('open');_syncNavVisibilityForModals();}
...
// (modals.js, renovasi.js, transaksi.js, features-tukang-kendaraan-storage.js, dst) lewat
...
// Digabung dari features-fi-checkoutscan-importexport-payroll.js (v89) — domainnya OCR juga,
...
// features-fi-checkoutscan-importexport-payroll.js — domainnya sama-sama seputar data transaksi,
...
// (v92): dipindah dari features-fi-checkoutscan-importexport-payroll.js — domainnya sama-sama seputar
...
// features-fi-checkoutscan-importexport-payroll.js — Export/import/backup data
...
// dipindah ke transaksi.js — domainnya sama-sama seputar data transaksi. Sisa 1 deklarasi nyasar
// (_lapLastFilterSig, tepat di bawah ini) BUKAN bagian domain itu — dipakai renderLaporan() bareng
// lapTxPage yang sudah lebih dulu di filter-laporan.js, jadi sebenarnya lebih cocok pindah ke sana;
// sengaja BELUM dipindah di sesi ini (di luar cakupan yang diminta), dicatat sbg PR kecil berikutnya.
// (v93): blok Payroll (const Payroll={...}, Absensi & Kalkulator Gaji Mingguan) sudah dipindah ke file
// baru payroll-absensi.js — sudah rapi sbg 1 objek modul, jadi dapat file domain sendiri. Sisa file ini
// sekarang MURNI domain export/import/backup + beberapa deklarasi nyasar (lihat catatan di bawah).
// Ditemukan juga 5 deklarasi nyasar lain (toggleMs/showTargetAccountTx/addTarget/delTarget/delReminder,
// domain Target/Milestone/Reminder di Pengaturan — pasangan saveTarget/saveCatatan/saveReminder/saveLDR
// sudah ada di transaksi.js sejak v83) — di luar cakupan sesi ini, dicatat sbg PR kecil berikutnya.
// PENTING: file ini HARUS dimuat sesuai urutan build.js (GROUP_A/GROUP_B) karena beberapa modul saling referensi. Urutan grup ini: data-default.js, features-helpers-global-security.js, diagnostik-versi.js, format-tema.js, error-handler.js, helper-teks.js, keamanan-pin.js, modal-navigasi.js, reset-gaji-mingguan.js, debug-console.js, pengaturan-search.js, onboarding.js, kalkulator-input.js, scan-ocr.js, filter-laporan.js, akun.js, gaji-calc.js, transaksi.js, profil-pengaturan.js, kategori.js, tagihan-kalender.js, features-fi-checkoutscan-importexport-payroll.js, payroll-absensi.js, features-tukang-kendaraan-storage.js, features-aiwidget-reminder-gdrive-search.js, features-sheets-pwa-selftest.js
...
csvParts.push(toCSVRow(['Nama','Jenis','Lokasi','Nilai Saat Ini','Modal Investasi','Tanggal Perolehan','Hitung ke Zakat Maal']));
out.assets.forEach(a=>csvParts.push(toCSVRow([a.name,a.jenis||'',a.lokasi||'',a.nilai||0,a.modalInvestasi||'',a.tanggal||'',a.zakatable?'Ya':'Tidak'])));
csvParts.push('');
...
// (v93): dipindah dari features-fi-checkoutscan-importexport-payroll.js — domain ini sudah rapi
