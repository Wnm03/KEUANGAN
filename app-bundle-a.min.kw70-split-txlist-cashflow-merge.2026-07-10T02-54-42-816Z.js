// app-bundle-a.min.js — DIBUAT OTOMATIS oleh build.js dari: modules-render.js, modals.js, modules-calc.js, cobek.js, piutang-utang.js, pajak-pbb-zakat.js, features-budget-laporan-carnotes-pelanggan.js, edukasi-dana.js, sewakios.js, hidup-seimbang.js, linktx.js, renovasi.js, aset.js, worthit.js
...
const MODULE_RENDER_VERSION='kw70-split-txlist-cashflow-merge';
...
// Wrapper global tipis ke FI.* — digabung dari features-fi-checkoutscan-importexport-payroll.js (v90),
...
// features-aiwidget-reminder-gdrive-search.js, features-fi-checkoutscan-importexport-payroll.js, modules-render.js
...
const waBtn=c.phone?`<button class="wa-btn" data-action="openWaShare" data-args="${escapeHtml(JSON.stringify(['Halo ${escapeHtml(c.name)}, terima kasih sudah jadi pelanggan Shop kami ya! 🪨🙏', escapeHtml(c.phone)]))}">💬 Chat WhatsApp</button>`:'';
...
const MODULE_FEATURES_VERSION='kw70-split-txlist-cashflow-merge';
const Budget={
editId:null,
curIcon:'🍚',
curPeriod:'bulanan',
...
// Wrapper global tipis ke Budget.* — digabung dari features-fi-checkoutscan-importexport-payroll.js (v91),
...
// PENTING: SewaKios.onLinkedTxDeleted()/onLinkedTxEdited() dipanggil dari features-fi-checkoutscan-importexport-payroll.js & transaksi.js (GROUP_B) saat transaksi diedit/dihapus — lewat variabel global, aman krn dipanggil runtime (bukan saat file di-load), asal file ini tetap ikut dimuat (selalu, lewat build.js).
